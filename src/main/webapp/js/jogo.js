...
function criarTabuleiro() {
    ...
    document.getElementById("quantidade-bombas-restantes").innerHTML = "Bombas restantes: " + jogo.tabuleiro.bombasRestantes;
    /*
     * {
     *      fimDoJogo: boolean,
     *      tabuleiro:{
...
function colocarOuRetirarBandeira(id) {
    ...
    if (jogo.tabuleiro.celulas[id.replace('img-flag-', '')].bandeira) {
        ...
        xhttp.send();
    } else if (jogo.tabuleiro.bombasRestantes > 0 &&
            !jogo.tabuleiro.celulas[id].revelada) {
